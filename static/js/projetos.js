const meusProjetos = [
    {
        id: "01",
        titulo: "Doçuras Enlaces",
        descricao: "Plataforma web comercial com catálogo visual e fluxo automatizado de pedidos integrado ao WhatsApp e EmailJS, substituindo o atendimento informal por uma interface de alta conversão.",
    ...
    },
    {
        id: "02",
        titulo: "GLAUKS (WEB)",
        descricao: "Plataforma administrativa (Web) para mapeamento, catalogação e gestão digital de acervo e empréstimos de bibliotecas escolares. Premiado com medalha de bronze na 13ª PROJETEC.",
    ...
    {
        id: "03",
        titulo: "GLAUKS (Mobile)",
        descricao: "Aplicativo mobile desenvolvido para alunos realizarem consultas ao acervo, reservas remotas e acompanhamento de empréstimos e leitura. Premiado na 13ª PROJETEC.",
    ...
    {
        id: "04",
        titulo: "Heartopia: Catálogo e Guia Interativo",
    ...
    {
        id: "05",
        titulo: "VULPI: Sistema Colaborativo de Achados e Perdidos",
        descricao: "Protótipo colaborativo de achados e perdidos com feed social (fórum), sistema de votação/comentários em tempo real e catálogo interativo integrado ao Firestore.",
    ...
    },
    {
        id: "06",
        titulo: "Matsuno",
        descricao: "Website acadêmico responsivo simulando um restaurante japonês moderno. Apresenta menu dinâmico de pratos, galeria de produtos, efeitos visuais de transição e sliders de parceiros.",
        linkCodigo: "https://github.com/ju-franco/matsuno",
